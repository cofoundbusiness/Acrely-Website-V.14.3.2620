        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed text-lg">
              Explore premium Grade A office buildings and business parks situated directly within high-density commercial hubs.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mt-4 max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Our acquisitions team is processing high-quality office assets. Exclusive early access will be available soon.
          </p>
        </motion.div>
      </section>
