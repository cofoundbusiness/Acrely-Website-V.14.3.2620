        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed text-lg">
              Strategic land banks and development sites primed for long-term appreciation or immediate commercial development.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mt-4 max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Our acquisitions team is processing high-quality land assets. Exclusive early access will be available soon.
          </p>
        </motion.div>
      </section>
